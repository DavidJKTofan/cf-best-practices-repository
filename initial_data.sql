...
INSERT INTO BestPractices (title, description, domain, category_id, feature_id, recommendation_level, impact_level, difficulty_level, prerequisites, expressions_configuration_details, source_reference, notes) VALUES
('Block Fallthrough API Requests (API Shield)', 'If using API Shield with a positive security model, create a WAF rule to block requests to API hostnames that do not match any saved and defined operation/endpoint.', 'Security', 9, 6, 'Recommended', NULL, NULL, NULL, '`(http.host in {"api.example.com"} and cf.api_gateway.fallthrough_detected)`', 'https://developers.cloudflare.com/ruleset-engine/rules-language/fields/reference/cf.api_gateway.fallthrough_detected/', 'Enforces positive security model. Requires a Cloudflare API Shield subscription.');

INSERT INTO BestPractices (title, description, domain, category_id, feature_id, recommendation_level, impact_level, difficulty_level, prerequisites, expressions_configuration_details, source_reference, notes) VALUES
('Log Non-Standard HTTP Methods', 'Create a WAF Custom Rule with Log action to gain visibility into non-standard HTTP methods being used (POST, PUT, DELETE etc.) on specific endpoints.', 'Security', 4, 2, 'Situational', NULL, NULL, NULL, '`(http.request.method in {"POST" "PURGE" "PUT" "HEAD" "OPTIONS" "DELETE" "PATCH"})`', 'https://developers.cloudflare.com/ruleset-engine/rules-language/fields/reference/http.request.method/', NULL);
...
INSERT INTO BestPractices (title, description, domain, category_id, feature_id, recommendation_level, impact_level, difficulty_level, prerequisites, expressions_configuration_details, source_reference, notes) VALUES
('Mitigate Traffic from Managed IP Lists', 'Create WAF Custom Rules to block or challenge traffic based on Cloudflare Managed IP Lists (Anonymizers, Botnets, Malware, Open Proxies, VPNs).', 'Security', 4, 14, 'Recommended', NULL, NULL, NULL, '`(ip.src in $cf.botnets_command_and_control) or (ip.src in $cf.malware)`', 'https://developers.cloudflare.com/waf/tools/lists/managed-lists/', 'Typically block Botnets/Malware. Consider mitigating specific VPN ASNs manually if needed.');

INSERT INTO BestPractices (title, description, domain, category_id, feature_id, recommendation_level, impact_level, difficulty_level, prerequisites, expressions_configuration_details, source_reference, notes) VALUES
('Mitigate Tor Traffic (WAF Rule)', 'Create a WAF Custom Rule to block or challenge traffic originating from the Tor network if it is unwanted.', 'Security', 4, 2, 'Situational', NULL, NULL, NULL, '`(ip.geoip.continent eq "T1")`', 'https://developers.cloudflare.com/ruleset-engine/rules-language/fields/reference/ip.src.continent/', 'Ensure Onion Routing feature is disabled in the Zone Network Settings if blocking Tor.');

INSERT INTO BestPractices (title, description, domain, category_id, feature_id, recommendation_level, impact_level, difficulty_level, prerequisites, expressions_configuration_details, source_reference, notes) VALUES
('Mitigate Unwanted ASNs', 'Create WAF Custom Rules (preferably using Lists) to block or challenge traffic from specific Autonomous System Numbers (ASNs), such as unwanted cloud providers or specific networks.', 'Security', 4, 2, 'Situational', NULL, NULL, NULL, '`(ip.geoip.asnum in {14618 16509})`', 'https://developers.cloudflare.com/ruleset-engine/rules-language/fields/reference/ip.src.asnum/', 'Use Lists for easier management.');

INSERT INTO BestPractices (title, description, domain, category_id, feature_id, recommendation_level, impact_level, difficulty_level, prerequisites, expressions_configuration_details, source_reference, notes) VALUES
('Block High Risk Countries (OFAC)', 'Create a WAF Custom Rule to block traffic from countries identified as high-risk or subject to sanctions (e.g., OFAC list).', 'Security', 4, 2, 'Situational', NULL, NULL, NULL, '`(ip.geoip.country in {"BY" "CU" "IR" "KP" ...})`', 'https://sanctionssearch.ofac.treas.gov/', 'The List requires updating based on current sanctions lists. Use the Cloudflare API, SDK, or Terraform for automation.');

INSERT INTO BestPractices (title, description, domain, category_id, feature_id, recommendation_level, impact_level, difficulty_level, prerequisites, expressions_configuration_details, source_reference, notes) VALUES
('Block Known Bot User-Agents', 'Create a WAF Custom Rule to block requests with User-Agent strings commonly used by unwanted bots (e.g., curl, go-http-client, empty).', 'Security', 4, 2, 'Situational', NULL, NULL, NULL, '`(http.user_agent contains "curl") or (http.user_agent contains "go-http-client") or (http.user_agent eq "")`', 'https://developers.cloudflare.com/ruleset-engine/rules-language/fields/reference/http.user_agent/', 'Be careful with over-blocking some User-Agents.');

INSERT INTO BestPractices (title, description, domain, category_id, feature_id, recommendation_level, impact_level, difficulty_level, prerequisites, expressions_configuration_details, source_reference, notes) VALUES
('Restrict WordPress (WP) Admin Access (IP/Access)', 'For WordPress (WP) sites, restrict access to /wp-admin using a WAF Custom Rule matching specific source IPs (preferably via List) or (highly recommended) implement Zero Trust using Cloudflare Access.', 'Security', 10, 2, 'Recommended', NULL, NULL, NULL, '`(not ip.src in $allowed_ips and http.request.uri.path contains "/wp-admin")`. Action: Block', 'https://developers.cloudflare.com/waf/tools/lists/', 'Preferably use Cloudflare Access for a Zero Trust approach instead.');

INSERT INTO BestPractices (title, description, domain, category_id, feature_id, recommendation_level, impact_level, difficulty_level, prerequisites, expressions_configuration_details, source_reference, notes) VALUES
('Restrict Access to Employee Locations (IP/Access)', 'For internal portals, restrict access using a WAF Custom Rule to only allow countries where employees are located, or preferably (and highly recommended) use Cloudflare Access.', 'Security', 10, 2, 'Recommended', NULL, NULL, NULL, '`(not ip.geoip.country in {"US" "GB"})`. Action: Block.', 'https://developers.cloudflare.com/waf/custom-rules/use-cases/allow-traffic-from-specific-countries/', 'Be specific with your rules. Consider mTLS as an alternative, however, it is strongly recommended to use Cloudflare Access instead.');

INSERT INTO BestPractices (title, description, domain, category_id, feature_id, recommendation_level, impact_level, difficulty_level, prerequisites, expressions_configuration_details, source_reference, notes) VALUES
('Enforce mTLS Authentication', 'For specific hostnames requiring mutual TLS, create a WAF Custom Rule to block requests without a valid, verified client certificate.', 'Security', 10, 10, 'Recommended', NULL, NULL, NULL, '`(http.host in {"mtls.example.com" "mtls2.example.com"} and (not cf.tls_client_auth.cert_verified or cf.tls_client_auth.cert_revoked))`', 'https://developers.cloudflare.com/learning-paths/mtls/mtls-app-security/related-features/#waf-for-client-certificates', 'Follow the best practices for mTLS configuration. Ensure the client certificate is verified and not expired.');

INSERT INTO BestPractices (title, description, domain, category_id, feature_id, recommendation_level, impact_level, difficulty_level, prerequisites, expressions_configuration_details, source_reference, notes) VALUES
('Block Revoked mTLS Certificates', 'Enhance mTLS by also blocking requests presenting a revoked client certificate.', 'Security', 10, 10, 'Recommended', NULL, NULL, NULL, '`(http.host in {"mtls.example.com"} and (not cf.tls_client_auth.cert_verified or cf.tls_client_auth.cert_revoked))`. Action: Block.', 'https://developers.cloudflare.com/learning-paths/mtls/mtls-app-security/related-features/#certificate-revocation', 'Follow the best practices for mTLS configuration. Ensure the client certificate is verified and not expired.');

INSERT INTO BestPractices (title, description, domain, category_id, feature_id, recommendation_level, impact_level, difficulty_level, prerequisites, expressions_configuration_details, source_reference, notes) VALUES
('Allow Specific mTLS Client Certificates', 'For granular control, create WAF rules to allow mTLS access only for specific client certificate serial numbers or even the issuer Subject Key Identifier (SKI) hash on certain hostnames.', 'Security', 10, 10, 'Situational', NULL, NULL, NULL, '`(http.host in {"mtls.example.com"} and cf.tls_client_auth.cert_serial ne "SPECIFIC_SERIAL_NUMBER")`', 'https://developers.cloudflare.com/api-shield/security/mtls/configure/#create-an-mtls-rule', 'Review the available mTLS fields for Rules.');

INSERT INTO BestPractices (title, description, domain, category_id, feature_id, recommendation_level, impact_level, difficulty_level, prerequisites, expressions_configuration_details, source_reference, notes) VALUES
('Challenge Admin JWT Users with High WAF Score', 'For APIs using JWT, create a WAF Custom Rule to challenge requests where the JWT indicates an admin user AND the WAF Attack Score is high.', 'Security', 9, 2, 'Situational', NULL, NULL, NULL, '`(lookup_json_string(http.request.jwt.claims[0], "user") eq "admin" and cf.waf.score lt 40)`. Action: Block.', 'https://developers.cloudflare.com/waf/custom-rules/use-cases/check-jwt-claim-to-protect-admin-user/', 'Requires parsing JWT claims and using the Cloudflare API Shield JSON Web Tokens (JWT) Validation feature.');
...
-- ==================
INSERT INTO BestPractices (title, description, domain, category_id, feature_id, recommendation_level, impact_level, difficulty_level, prerequisites, expressions_configuration_details, source_reference, notes) VALUES
('Log Likely Automated Traffic (Bot Score)', 'Create a WAF Custom Rule with Log action to gain visibility into traffic Cloudflare classifies as likely automated based on Bot Score.', 'Security', 6, 4, 'Recommended', NULL, NULL, NULL, '`(cf.bot_management.score lt 30)`', 'https://developers.cloudflare.com/waf/custom-rules/use-cases/challenge-bad-bots/', 'Adjust threshold as needed. Requires a Cloudflare Enterprise Bot Management subscription.');

INSERT INTO BestPractices (title, description, domain, category_id, feature_id, recommendation_level, impact_level, difficulty_level, prerequisites, expressions_configuration_details, source_reference, notes) VALUES
('Enforce JavaScript Detections (JSD)', 'For critical HTML sites, enforce JSD by challenging requests that fail the JSD check.', 'Security', 6, 4, 'Situational', NULL, NULL, NULL, '`(http.request.uri.path eq "/critical/path" and not cf.bot_management.js_detection.passed)`. Action: Block.', 'https://developers.cloudflare.com/bots/additional-configurations/javascript-detections/#enforcing-execution-of-javascript-detections', 'Requires a Cloudflare Enterprise Bot Management subscription. JSD only injects on HTML responses and cannot run on the first request.');

INSERT INTO BestPractices (title, description, domain, category_id, feature_id, recommendation_level, impact_level, difficulty_level, prerequisites, expressions_configuration_details, source_reference, notes) VALUES
('Mitigate IPv6 Traffic (If Unwanted)', 'If IPv6 is not needed or desired, create a WAF Custom Rule to block or challenge traffic from IPv6 source addresses.', 'Security', 4, 2, 'Situational', NULL, NULL, NULL, '`(ip.src in {::/0})`. Action: Block.', 'https://developers.cloudflare.com/network/ipv6-compatibility/', 'Consider disabling IPv6 compatibility in Zone Network Settings as well.');

INSERT INTO BestPractices (title, description, domain, category_id, feature_id, recommendation_level, impact_level, difficulty_level, prerequisites, expressions_configuration_details, source_reference, notes) VALUES
('Use Account Takeover Detections', 'Leverage Cloudflare Enterprise Bot Management Detection IDs in WAF or Rate Limiting rules to mitigate predictable bot behavior like login failures.', 'Security', 6, 4, 'Recommended', NULL, NULL, NULL, '`(any(cf.bot_management.detection_ids[*] eq 201326592) and http.request.uri.path contains "/login")`', 'https://developers.cloudflare.com/bots/additional-configurations/detection-ids/', 'Requires a Cloudflare Enterprise Bot Management subscription. Consider also implementing Turnstile, a CAPTCHA alternative.');
...
-- ==================
INSERT INTO BestPractices (title, description, domain, category_id, feature_id, recommendation_level, impact_level, difficulty_level, prerequisites, expressions_configuration_details, source_reference, notes) VALUES
('Implement Time-Based Rules', 'Use the `http.request.timestamp.sec` field in WAF rules to apply logic based on specific time periods (e.g., block POSTs during maintenance window).', 'Security', 4, 2, 'Situational', NULL, NULL, NULL, '`(http.request.method eq "POST" and http.request.timestamp.sec gt 1712779200 and http.request.timestamp.sec lt 1712782800)`', 'https://developers.cloudflare.com/ruleset-engine/rules-language/fields/reference/http.request.timestamp.sec/', 'The timestamp is represented in UNIX time and consists of a 10-digit value.');

INSERT INTO BestPractices (title, description, domain, category_id, feature_id, recommendation_level, impact_level, difficulty_level, prerequisites, expressions_configuration_details, source_reference, notes) VALUES
('Mitigate Unauthorized Worker Subrequests', 'Prevent abuse from other Cloudflare Workers by using the WAF rules to block subrequests originating from unknown Cloudflare Workers.', 'Security', 4, 18, 'Situational', NULL, NULL, NULL, '`not (cf.worker.upstream_zone in {"" "you-zone.com"})`', 'https://developers.cloudflare.com/fundamentals/reference/http-headers/#cf-worker', 'Review the documentation on `CF-Connecting-IP` HTTP Request Header in Worker subrequests.');
...
-- ==================
INSERT INTO BestPractices (title, description, domain, category_id, feature_id, recommendation_level, impact_level, difficulty_level, prerequisites, expressions_configuration_details, source_reference, notes) VALUES
('Use Advanced Certificate Manager (ACM)', 'Prefer ACM over Universal SSL for more control over certificates, hostnames, and settings.', 'Security', 2, 15, 'Recommended', NULL, NULL, NULL, NULL, 'https://developers.cloudflare.com/ssl/edge-certificates/advanced-certificate-manager/', 'Review the different SSL and TLS settings, as well as customization requirements. Those seeking PCI compliance and granular customization over cipher suites should review the developer documentations, as well as the features TLS 1.3, Minimum TLS Version (TLS 1.2 is the recommended option here), Automatic HTTPS Rewrites, Always Use HTTPS (or preferably disable HTTP plaintext altogether).');

INSERT INTO BestPractices (title, description, domain, category_id, feature_id, recommendation_level, impact_level, difficulty_level, prerequisites, expressions_configuration_details, source_reference, notes) VALUES
('Disable Universal SSL (and use ACM or Custom Certificates instead)', 'If using ACM or Custom Certificates, disable the Universal SSL certificate for the Zone.', 'Security', 2, 5, 'Situational', NULL, NULL, NULL, NULL, 'https://developers.cloudflare.com/ssl/edge-certificates/universal-ssl/', 'Verify that there is always a valid and active Edge Certificate for your hostnames.');

INSERT INTO BestPractices (title, description, domain, category_id, feature_id, recommendation_level, impact_level, difficulty_level, prerequisites, expressions_configuration_details, source_reference, notes) VALUES
('Set Minimum TLS Version to 1.2', 'Configure Cloudflare to only allow TLS 1.2 or higher connections for improved security.', 'Security', 2, 5, 'Recommended', NULL, NULL, NULL, NULL, 'https://developers.cloudflare.com/ssl/edge-certificates/additional-options/minimum-tls/', 'Enable TLS 1.3. Recommended option for compliance and security.');

INSERT INTO BestPractices (title, description, domain, category_id, feature_id, recommendation_level, impact_level, difficulty_level, prerequisites, expressions_configuration_details, source_reference, notes) VALUES
('Enable Always Use HTTPS', 'Force all visitor connections to use HTTPS.', 'Security', 2, 5, 'Mandatory', NULL, NULL, NULL, NULL, 'https://developers.cloudflare.com/ssl/edge-certificates/additional-options/always-use-https/', 'Consider also enabling HSTS as well. Preferably disable plaintext HTTP entirely.');

INSERT INTO BestPractices (title, description, domain, category_id, feature_id, recommendation_level, impact_level, difficulty_level, prerequisites, expressions_configuration_details, source_reference, notes) VALUES
('Enable Automatic HTTPS Rewrites', 'Allow Cloudflare to automatically rewrite HTTP links to HTTPS in HTML source code.', 'Security', 2, 5, 'Recommended', NULL, NULL, NULL, NULL, 'https://developers.cloudflare.com/ssl/edge-certificates/additional-options/automatic-https-rewrites/', 'Helps prevent mixed content warnings. Review your application source code.');

INSERT INTO BestPractices (title, description, domain, category_id, feature_id, recommendation_level, impact_level, difficulty_level, prerequisites, expressions_configuration_details, source_reference, notes) VALUES
('Enable HTTP/2 and HTTP/3', 'Enable modern HTTP protocols (HTTP/2, HTTP/3 QUIC) for performance and security improvements.', 'Performance', 8, 5, 'Recommended', NULL, NULL, NULL, NULL, 'https://developers.cloudflare.com/speed/optimization/protocol/http3/', 'Review the Speed Optimization features.');

INSERT INTO BestPractices (title, description, domain, category_id, feature_id, recommendation_level, impact_level, difficulty_level, prerequisites, expressions_configuration_details, source_reference, notes) VALUES
('Enable HTTP/2 to Origin', 'Allow Cloudflare to use HTTP/2 when connecting to your origin servers if supported.', 'Performance', 8, 5, 'Recommended', NULL, NULL, NULL, NULL, 'https://developers.cloudflare.com/speed/optimization/protocol/http2-to-origin/', 'Requires origin server support for HTTP/2. Adjust the connection multiplexing (request pooling).');
...
-- ==================
INSERT INTO BestPractices (title, description, domain, category_id, feature_id, recommendation_level, impact_level, difficulty_level, prerequisites, expressions_configuration_details, source_reference, notes) VALUES
('Use Logpush for Comprehensive Logs', 'Configure Logpush to send detailed Firewall events, HTTP request, or other logs to a storage service (R2, S3) or SIEM.', 'Security', 11, 11, 'Recommended', NULL, NULL, NULL, NULL, 'https://developers.cloudflare.com/logs/about/', 'Logpush is strongly recommended for long-term storage and non-sampled logs.');

INSERT INTO BestPractices (title, description, domain, category_id, feature_id, recommendation_level, impact_level, difficulty_level, prerequisites, expressions_configuration_details, source_reference, notes) VALUES
('Set Up Notifications', 'Configure Cloudflare Notifications for relevant events (security events, certificate expiry, DDoS attacks, etc.).', 'Security', 11, NULL, 'Recommended', NULL, NULL, NULL, NULL, 'https://developers.cloudflare.com/notifications/', 'Review available Notifications and configure them based on your needs. Consider using the Cloudflare API or Terraform for automation.');
...
INSERT INTO BestPractices (title, description, domain, category_id, feature_id, recommendation_level, impact_level, difficulty_level, prerequisites, expressions_configuration_details, source_reference, notes) VALUES
('Rotate Origin IPs After Onboarding', 'After migrating to Cloudflare and proxying records, change your origin server IP addresses.', 'Security', 7, NULL, 'Recommended', NULL, NULL, NULL, NULL, 'https://developers.cloudflare.com/fundamentals/security/protect-your-origin-server/', 'Review the Cloudflare documentation and follow the best practices.');

INSERT INTO BestPractices (title, description, domain, category_id, feature_id, recommendation_level, impact_level, difficulty_level, prerequisites, expressions_configuration_details, source_reference, notes) VALUES
('Use Transform Rules for Security Headers', 'Leverage Managed Transforms or create custom Transform Rules to add or modify security response headers.', 'Security', 7, 2, 'Recommended', NULL, NULL, NULL, NULL, 'https://developers.cloudflare.com/rules/transform/managed-transforms/reference/', 'Use Cloudflare Snippets for more customizable HTTP header modifications or other custom logics.');
...
INSERT INTO BestPractices (title, description, domain, category_id, feature_id, recommendation_level, impact_level, difficulty_level, prerequisites, expressions_configuration_details, source_reference, notes) VALUES
('Use API Shield Sequence Mitigation', 'Define expected sequences of API calls and use Cloudflare API Shield Sequence Mitigation to detect and block out-of-order requests.', 'Security', 9, 6, 'Recommended', NULL, NULL, NULL, NULL, 'https://developers.cloudflare.com/api-shield/security/sequence-mitigation/', 'Review the Cloudflare documentation.');
